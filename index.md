...
I use a variety of tools, software and operating systems, so here's a list of my favorites:

- [Rust](https://en.wikipedia.org/wiki/Rust_(programming_language))
- [Java](https://en.wikipedia.org/wiki/Java_(programming_language))
- [HTML/CSS](https://en.wikipedia.org/wiki/Front-end_web_development)
...
- [Nix/NixOS](https://en.wikipedia.org/wiki/Nix_(package_manager))
...
- [Steam](https://steamcommunity.com/id/cylenia)
